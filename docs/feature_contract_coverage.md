...
| Evaluation totals, failure denominator, evidence, latency, availability and provenance | `test_evaluation.py`, `test_graph.py`, `test_api_mcp.py` | Interrupted-run recovery Q06, repeated live quality Q07 |
