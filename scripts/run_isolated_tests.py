...
TEST_FILES = ("tests/test_parser_formats.py", "tests/isolated/test_environment.py",
              ...
              "tests/isolated/test_budgets.py", "tests/isolated/test_tracing.py", "tests/isolated/test_privacy.py", "tests/isolated/test_evaluation.py", "tests/isolated/test_evaluation_recovery.py", "tests/isolated/test_citations.py", "tests/isolated/test_sql_policy.py", "tests/isolated/test_ingestion.py", "tests/isolated/test_document_identity.py", "tests/isolated/test_file_intake.py", "tests/isolated/test_reconciliation.py", "tests/isolated/test_pattern_retention.py", "tests/isolated/test_sentry.py", "tests/isolated/test_template_miner.py")
